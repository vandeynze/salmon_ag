...
types$cropgroup <- if_else(types$cdl_west == "111", "Open Water", types$cropgroup)
          ...
          # Join types to the land use data frame
           ...
           p_ag_cover <-
             ...
             scale_fill_manual( "Land Cover (CDL2021)",
                          limits = c("Small Grains", "Nuts", "Fruits", "Vegetables", "Other Crops", "Hay", "Rice","Cotton","Fallow","Grapes","Pasture", "Other", "Potatoes", "Corn", "Open Water"),
      labels = c("Small Grains", "Nuts", "Fruits", "Vegetables", "Other Crops", "Hay", "Rice","Cotton","Fallow","Grapes","Pasture", "Other", "Potatoes", "Corn", "Open Water"),
      values = c("goldenrod", "darkgoldenrod", "darkred", "lightgreen", "purple", "darkgreen", "pink", "tan", "grey", "violet", "springgreen3", "antiquewhite1", "black", "gold", "darkblue")) +
