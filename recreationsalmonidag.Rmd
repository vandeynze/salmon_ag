...
#break up renaming into chunks
df_clip2_1 <-
  df_clip2 %>% slice(1:30818117) %>% mutate(cdl_west = updateNamesCDL(cdl_west))
df_clip2_2 <-
  df_clip2 %>% slice(30818117:61636234) %>% mutate(cdl_west = updateNamesCDL(cdl_west))  
df_clip2_3 <-
  df_clip2 %>% slice(61636234:92454351) %>% mutate(cdl_west = updateNamesCDL(cdl_west))  
df_clip2_4 <-
  df_clip2 %>% slice(92454351:123272468) %>% mutate(cdl_west = updateNamesCDL(cdl_west))  
df_clip2_5 <-
  df_clip2 %>% slice(123272468:154090584) %>% mutate(cdl_west = updateNamesCDL(cdl_west))

# Combine
df_clip2 <-
  bind_rows(df_clip2_1, df_clip2_2, df_clip2_3, df_clip2_4, df_clip2_5)
rm(df_clip2_1, df_clip2_2, df_clip2_3, df_clip2_4, df_clip2_5)
...
#df_clip2_types<- df_clip2_types %>% mutate(cdl_west = updateNamesCDL(cdl_west))
types<-types %>%
